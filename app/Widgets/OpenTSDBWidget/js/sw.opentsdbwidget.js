...
//            }
            ...
            sw_opentsdbwidget_backtitle = (this.sw_opentsdbwidget_backtitle = $('<div>'))
            ...
            sw_opentsdbwidget_savedsearchesmenu = (this.sw_opentsdbwidget_savedsearchesmenu = $('<div>'))
                ...
                .appendTo(sw_opentsdbwidget_backtitle);
            ...
            sw_opentsdbwidget_backfooter.append('<div class="glue1">');
...
//            that.build_search_form();
            ...
            this.sw_opentsdbwidget_backtitle.remove();
...
//                , graph_div = widget.sw_opentsdbwidget_frontmain.children('div.graphdiv')
...
//            var widget = this;
//            $(window).scrollTop(0);
//            widget.start_height = widget.sw_opentsdbwidget.parent().height();
//            widget.start_width = widget.sw_opentsdbwidget.parent().width();
//            widget.widget_position = widget.sw_opentsdbwidget.parent().position();
//            widget.sw_opentsdbwidget.addClass('flipped');
//            $('div.container').after('<div class="bodyshade transparent">');
//            setTimeout(function() {
//                widget.sw_opentsdbwidget.parent().css({position: 'absolute', height: widget.start_height + 'px', width: widget.start_width + 'px', top: widget.widget_position.top, left: widget.widget_position.left, 'z-index': '500'})
...
//                widget.sw_opentsdbwidget.parent().css({top: '15%', left: '15%', height: '70%', width: '65%'});
...
//                widget.sw_opentsdbwidget.parent().css({width: widget.start_width, height: '', top: widget.widget_position.top, left: widget.widget_position.left});
//                setTimeout(function() {
//                    widget.sw_opentsdbwidget.parent().css({position: '', top: '', left: '', 'z-index': '', height: '', width: ''})
...
//                        '<input type="text" name="search-title-input' + widget_num + '" class="nodisplay" size="50">');
...
//
//                widget.sw_opentsdbwidget_frontmain.append('<div id="graphdiv' + widget_num + '" class="graphdiv" style="width: 99%;">')
...
//                }
//
//                widget.sw_opentsdbwidget_frontmain.on('click', 'button.legend-hide', function() {
//                    widget.hide_legend(this);
//                });
//
//                widget.sw_opentsdbwidget_frontmain.on('click', 'button.legend-show', function() {
...
//                var saved_search_list = widget.sw_opentsdbwidget_backtitle.children('.saved-searches-menu').children('ul.saved-searches-options')
...
//                        for (i = 0; i < max; i++) {
//                            if (public_searches[i].user_id === document._session.dashboard_userid) {
...
//                }
//
//                widget.sw_opentsdbwidget_backtitle.children('.saved-searches-menu').children('ul.saved-searches-options').on('click', 'li', function() {
//                    var saved_query = {};
...
//                if (prompt_user) {
//                    setTimeout(function() {
//                        if ($(widget.sw_opentsdbwidget_containerid).parent().attr('id') === "adhoc-container") {
//                            widget.sw_opentsdbwidget.addClass('flipped');
//                        }
//                        else {
//                            widget.edit_params();
...
//                    // fail: Show error image and error message
//                    , function(status) {
//                        widget.sw_opentsdbwidget_frontmain.children('#graphdiv' + widget_num).children('.bowlG')
...
//
//                        widget.sw_opentsdbwidget_frontmain.children('#graphdiv' + widget_num).children('#status-box' + widget_num).empty()
...
//                                widget.sw_opentsdbwidget_frontmain.children('#graphdiv' + widget_num).children('#status-box' + widget_num)
//                                    .append('<iframe style="margin: 0 auto; color: rgb(205, 205, 205);" width="80%" height="90%" srcdoc=\'' + error_message + '\' seamless></iframe>');
//                            }
//                            else {
//                                widget.sw_opentsdbwidget_frontmain.children('#graphdiv' + widget_num).children('#status-box' + widget_num).text(status);
//                            }
//                        }
//                    }
//                );
...
//            var widget_num = widget.uuid;
//            var status = widget.sw_opentsdbwidget_frontmain.children('#graphdiv' + widget_num).children('#status-box' + widget_num).children('#status-message' + widget_num);
//
...
//            widget.sw_opentsdbwidget_frontmain.children('.graphdiv').css('height', (widget.sw_opentsdbwidget_frontmain.innerHeight() - (widget.sw_opentsdbwidget_frontmain.children('.legend-container').outerHeight(true) + graphdiv_offset)));
//            widget.sw_opentsdbwidget_frontmain.children('.legend-container').css('width', widget.sw_opentsdbwidget_frontmain.innerWidth())
//                .removeClass('hidden');
//
